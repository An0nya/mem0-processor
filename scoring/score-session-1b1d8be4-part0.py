...
CHECKS_DEF = [
    ...
    ('kv_quant_not_recorded',
     r'(kv.quant.{0,40}(not.record|missing|null|registry.value|wrong)'
     r'|kvQuantK.{0,30}null'
     r'|resolved.{0,20}kv.quant.{0,30}(not|miss|lost|wrong)'
     r'|registry.value.{0,30}not.resolved'
     r'|perf.{0,20}store.{0,30}kv.quant.{0,30}(null|wrong|miss)'
     r'|kvQuant.{0,30}not.{0,20}record'
    ...
    ('stale_memory',
     ...
     r'|project_v9_plan.{0,30}(stale|wrong|3.days))'),
]
